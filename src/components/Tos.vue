<template>
  <div class="tos">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          Agreement) refers to Seibert Software Solutions, LLC, .
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          ...
          refers to Icon Generator AI, accessible from
          <a target="_blank" href="/">icongeneratorai.com</a>
        </p>
      </li>
      <li>
        <p>
    ...
    <p>
      We can use your icons to promote our service. This includes, but is not
      limited to: online ads, physical ads, social media posts, and anywhere
    ...
    <p>
      Our service uses AI provided by OpenAI to generate icons. Please review
      copyright laws for your country and state in regards to AI generated art
      or images. By using our services, you agree that our company and service
      assumes no responsibility for the images generated. Nor do we assume
    ...
    <ul>
      <li>By email: ceo-of-based@gmail.com</li>
    </ul>
  </div>
</template>
